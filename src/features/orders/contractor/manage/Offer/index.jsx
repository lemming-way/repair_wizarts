...
import { useOrdersByIds } from '../../../../../state/order';
...
function Offer() {
  ...
  const service = services?.[order?.serviceId] || text('Unknown service');
      ...
      <div className={style.order_row}>
        <div className={style.left}>
          <div className={style.profile}>
            <img src={clientProfileImage} alt={clientName} className={style.style.avatar} />
          ...
          <p className={style.description}>{service}</p>
