...
function ChoiceOfReplenishmentMethodCard() {
  ...
  const scrollToBottom = () => {
    window.scrollTo({
      top: document.documentElement.scrollHeight, // Прокручиваем до самого низа страницы
  ...
  const behaiveStyles: React.CSSProperties = {
    ...
    bottom: '20px',
    right: '20px',
    background: 'transparent', // Сделаем фон кнопки прозрачным
    border: 'none',
    cursor: 'pointer',
    padding: '0',
  ...
  const imageStyles: React.CSSProperties = {
    width: '40px', // Размер изображения, можно настроить под ваш дизайн
    height: '40px', // Размер изображения, можно настроить под ваш дизайн
  };
  ...
  return (
    <>
      ...
      {zayavka__isVisibleModalFinal ? (
        <ConfirmOrderFinal_v2
          setVisibleConfirmOrderFinal={zayavka__SetVisibleModalFinal}
          setConfirmOrder={zayavka__setOpenDispute}
        />
      ) : null}
        ...
        {id ? (
          <div className="profil fchat__profile">
            ...
            >
              <Link to="/profile-number">
                <div className="kirill df align" style={{ gap: '10px' }}>
                  ...
                  <div className="nik">
                    <h2 className="eyrqwe">Кирилл Воронов</h2>
            ...
            <div className="chatt awqervgg chat_block__ashd">
              ...
              {zayavka__isVisibleModal || zayavka__isOpenDispute ? null : (
                <div className="chat_technical_message">
                  <div className={styles.confirm_block}>
                    <button onClick={() => zayavka__SetVisibleModal(true)}>
                      Подтвердить заявку
                    </button>
              ...
              {isConfirmOrder || order__isDenyOrder ? null : (
                <div className="chat_technical_message">
                  <div className={styles.confirm_block}>
                    <button onClick={() => setVisibleConfirmOrderFinal(true)}>
                      Подтвердить заказ
                    </button>
              ...
              <div className="chat_technical_message">
                <div
                  className={`${styles.cancel_block} ${
                    visibleTestCancel3 != 'deny' ? styles.display_none : null
                  }`}
                >
                  <img src="/img/cansel_message.png" alt="" />
                ...
                <div
                  className={`${styles.confirm_block} ${
                    visibleTestCancel3 != '' ? styles.display_none : null
                  }`}
                >
                  <button onClick={() => setVisibleTestCancel3('access')}>
                    Подтвердить заявку
                  </button>
                  <button onClick={() => setVisibleTestCancel3('deny')}>
                    Отменить заявку
                  </button>
                </div>
                ...
                <div
                  className={`${
                    visibleTestCancel3 != 'access' ? styles.display_none : null
                  }`}
                >
                  <div className={`${styles.cancel_block}`}>
                    <img src="/img/message_green.png" alt="" />
                ...
                >
                  ...
                  {visibleTestCancel ? (
                    ...
                    <div className={styles.cancel_client_confirm}>
                      ...
                      <button onClick={() => setVisibleTestCancel(true)}>
                        Нет
                      </button>
                    </div>
                  )}
                ...
                >
                  ...
                  <div
                    className={`${styles.cancel_client_confirm} ${
                      visibleTestCancel2 != '' ? styles.display_none : null
                    }`}
                  >
                    <button onClick={() => setVisibleTestCancel2('access')}>
                      Подтвердить заявку
                    </button>
                    <button onClick={() => setVisibleTestCancel2('deny')}>
                      Отменить заявку
                    </button>
                  </div>
                  ...
                  <div
                    className={`${styles.cancel_block} ${
                      visibleTestCancel2 != 'deny' ? styles.display_none : null
                    }`}
                  >
                    <img src="/img/cansel_message.png" alt="" />
                    <p>Вы предложили отменить заявку 5:42</p>
                      ...
                      <div>
                        ...
                        <p>
                          ...
                          <a
                            className={styles.create_order__link}
                            href="#"
                            onClick={() => setOpenPovtor((prev) => !prev)}
                          >
                            №243
                          </a>
                        </p>
                ...
                <div className={styles.dispute_block}>
                  ...
                  <div className={styles.dispute_row}>
                    <button
                      ...
                      onClick={() => setVisibleCancelOrder(true)}
                    >
                      Подтвердить отмену заказа
                    </button>
                    <button
                      className={styles.dispute_button}
                      onClick={() => setVisibleModalArbitation(true)}
                    >
