...
import registrationDefaultContractorImg from 'app/img/users/registrationPick/registration-contractor.svg';
import registrationDefaultUserImg from 'app/img/users/registrationPick/registration-user.svg';
