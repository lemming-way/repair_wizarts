...
import clockImage from 'app/img/home/whyChooseUsBlock/clock.svg';
import contractorsImage from 'app/img/home/whyChooseUsBlock/contractors.svg';
import priceImage from 'app/img/home/whyChooseUsBlock/price.svg';
import qualityImage from 'app/img/home/whyChooseUsBlock/quality.svg';
...
const WhyChooseUsBlock = () => {
  ...
  return (
    <div className={`${styles.whyChooseUsBlock} ${styles.appContainer}`}>
      <h2 className={styles.whyChooseUsBlock_title}> {text("Why RepairWizards and not other contractor sites?")}
      </h2>
        <div className={styles.whyChooseUsBlock_cards}>
          ...
          text={text("All contractors are punctual and responsible. They overestimate the work time just in case but almost always finish earlier.")}
